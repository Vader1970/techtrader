...
import { getAllOrders, deleteOrder, setDelivered, resetErrorAndRemoval } from "../redux/actions/listingsActions";
...
const OrdersTab = () => {
  ...
  const { error, loading, orders, deliveredFlag, orderRemoval } = listings;
  //   Could be a problem
  const { userInfo } = user;
