...
const ProductScreen = () => {
  ...
  }, [dispatch, id, cart, reviewSend, questionSend, toast]);
            ...
            {userInfo && (
              <>
                <Button
                  ...
                  w="140px"
                  colorScheme="orange"
                  onClick={() => setQuestionBoxOpen(!questionBoxOpen)}
                >
                  Ask a question
                </Button>
                {questionBoxOpen && (
                      ...
                      <Box key={question._id}>
                        <Flex spacing="2px" alignItems="center">
                          <Text fontWeight="semibold">
                            {question.questionsTitle && question.questionsTitle}
                          </Text>
                        </Flex>
                        <Box py="12px">{question.questionsComment}</Box>
                        <Text fontSize="sm" color="gray.400">
                          by {question.questionsName},{" "}
